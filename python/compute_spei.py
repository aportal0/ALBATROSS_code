...
# --- load ---
ds_pet    = xr.open_dataset(f"{dir_pet}ET0_Mod-Hargreaves_monthly_1993-2024_Madagascar.nc", chunks={'time': 12})
ds_precip = xr.open_dataset(f"{dir_precip}precip_monthly_1993-2024_Madagascar.nc", chunks={'time': 12})
